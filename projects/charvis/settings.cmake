...
if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/root_task/Arm")
    set(AppArch "Arm" CACHE STRING "" FORCE)
elseif(EXISTS "${CMAKE_CURRENT_LIST_DIR}/root_task/x86")
...
if(AppArch STREQUAL "Arm")
    ...
    # Add VM application
    include("${CMAKE_CURRENT_LIST_DIR}/root_task/Arm/settings.cmake")
